            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="row">
                        ...
                        <h6><i class="ni ni-settings-gear-65"></i> Hoja de Vida del activo</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body px-2 pb-4">
                    ...
                    <!-- vencimientos de archivos cargados -->
                    <div class="row">
    ...
    <script>
        $(document).ready(function(){
            ...
            var table2 = $('#example2').DataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../../json/jstablasajax.php?tabla=ordenestrabajos&tipo=1&methodAcciones=0&refcamiones=<?php echo $id; ?>&archivo=1",
                "language": {
            ...
            var table3 = $('#example3').DataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../../json/jstablasajax.php?tabla=ordenestrabajos&tipo=0&methodAcciones=0&refcamiones=<?php echo $id; ?>&archivo=1",
                "language": {
                    "emptyTable":     "No hay datos cargados",
                    "info":           "Mostrar _START_ hasta _END_ del total de _TOTAL_ filas",
                    "infoEmpty":      "Mostrar 0 hasta 0 del total de 0 filas",
            ...
            var table = $('#exampleMantenimiento').DataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../../json/jstablasajax.php?tabla=mantenimiento&refcamiones=<?php echo $id; ?>",
                "language": {
                    "emptyTable":     "No hay datos cargados",
                    "info":           "Mostrar _START_ hasta _END_ del total de _TOTAL_ filas",
                    "infoEmpty":      "Mostrar 0 hasta 0 del total de 0 filas",
