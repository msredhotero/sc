...
$lst = $Camiones->traerTodosFilter(['patente'=> strtoupper( $busqueda)]);

//$ruta = $Cargos::RUTA;

$options['activo'] = 'Cargos';
$options['ids'] = '8,9,10';
              ...
              <div class="card-body px-2 pb-4">
                <div class="table-responsive">
                  ...
                  <table id="example" class="table align-items-center mb-0 display " style="width:100%">
                    <thead>
                      <tr>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Activos</th>
                    ...
                    <tbody>
                      ...
                      foreach ($lst as $row) {
                        $Camion = new Camiones();
                        $Camion->buscarPorId($row['id']);
                        $item = $Camion->devolverArray();
                      ?>
                      <tr>
                        <td><?php echo $item['activo']; ?></td>
                        <td><?php echo $item['patente']; ?></td>
                        <td><?php echo $item['kilometros']; ?></td>
                        <td><?php echo $item['modelo']; ?></td>
                        <td><?php echo $item['anio']; ?></td>
                        <td><button type="button" class="btn bg-gradient-success"><a href="../camiones/hojavida.php?id=<?php echo $row['id']; ?>">Hoja de Vida</button></a></td>
                      </tr>
                      <?php
                      }
                      ?>
