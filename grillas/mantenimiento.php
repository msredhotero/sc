...
//$lst = $Mantenimientoflota->traerAjaxMantenimiento();
  ...
  <div class="card">
    <div class="card-header pb-0">
      <div class="row">
        <div class="col-lg-6 col-7">
          <h6>Mantenciones Programadas</h6>
        </div>
    ...
    <div class="card-body px-2 pb-4">
      <div class="table-responsive">
        ...
        <table id="exampleMantenimiento" class="table align-items-center mb-0 display " style="width:100%">
            <thead>
                <tr>
