    ...
    <div class="card-body px-2 pb-4">
      <div class="table-responsive">
        ...
        <table id="example" class="table align-items-center mb-0 display " style="width:100%">
          <thead>
            <tr>
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ApyN</th>
              ...
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Alta</th>
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Baja</th>
