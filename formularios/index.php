            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-4">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient text-warning">Bienvenido a <?php echo $Globales::$tituloWeb; ?></h3>
                  <p class="mb-0">Ingresa tu email y password</p>
                </div>
                <div class="card-body">
                  <form class="formulario frmNuevo text-left" role="form" id="sign_in">
                    ...
                    <input type="hidden" name="accion" id="accion" value="iniciarSessionUsuarioWeb"/>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                  Aun no tienes una cuenta, ingresa aqui para registrarte?
                    <a href="registrar.php" class="text-info text-gradient font-weight-bold">Registrate</a>
                  </p>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                  He olvidado mi password
                    <a href="recuperarpassword.php" class="text-primary text-gradient font-weight-bold">Recuperar Password</a>
                  </p>
                </div>
              </div>
            </div>
