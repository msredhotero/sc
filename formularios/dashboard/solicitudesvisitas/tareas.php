...
$Solicitudesvisitas = new Solicitudesvisitas($_SESSION['user']->getUsername());

$refsolicitudesvisitas = $_GET['id'];

$Solicitudvisitadetalles = new Solicitudvisitadetalles($_SESSION['user']->getUsername(),$refsolicitudesvisitas);
...
$ruta = $Solicitudvisitadetalles::RUTA;

$options['activo'] = 'solicitudesvisitas';
$options['ids'] = '8,9,10';
        ...
        $(document).ready(function(){
          $('.btnVolver').click(function() {
            ...
            var table = $('#example').DataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../../json/jstablasajax.php?tabla=<?php echo $ruta; ?>&refsolicitudesvisitas=<?php echo $refsolicitudesvisitas; ?>",
                "language": {
