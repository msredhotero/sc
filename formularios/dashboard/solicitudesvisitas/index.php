...
$ruta = $Solicitudesvisitas::RUTA;

$options['activo'] = 'Solicitud de Visitas';
$options['ids'] = '8,9,10';
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="form-group">
              <input class="form-control" id="fechadesde" name="fechadesde" type="date" value="" id="fechadesde">
            </div>
          ...
          <div class="col">
            ...
            <div class="form-group">
              <input class="form-control" id="fechahasta" name="fechahasta" type="date" value="" id="fechahasta">
            </div>
          </div>
              ...
              'buttons': [
                   {
                    ...
                    'title': 'Listado de Solicitudes de Visita'                      
                   },     
                  ],
                "bProcessing": true,
                "bServerSide": true,
