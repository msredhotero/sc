...
$refordenestrabajodetalle = $_GET['id'];
        ...
        $(document).ready(function(){
          $('.btnVolver').click(function() {
            ...
            var table = $('#example').DataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../../json/jstablasajax.php?tabla=<?php echo $ruta; ?>&refordenestrabajodetalle=<?php echo $refordenestrabajodetalle; ?>",
                "language": {
