...
$Sucursales = new Sucursales(2,$idreferencia);
        ...
        $(document).ready(function(){
          $('.btnVolver').click(function() {
            ...
            var table = $('#example').DataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../../json/jstablasajax.php?tabla=<?php echo $ruta; ?>&reftabla=<?php echo $reftabla; ?>&idreferencia=<?php echo $idreferencia; ?>",
                "language": {
