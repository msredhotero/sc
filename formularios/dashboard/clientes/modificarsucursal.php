...
$Sucursales->buscarPorId($id);
$Clientes->buscarPorId($idcliente);

//die(var_dump($Sucursales->getIdreferencia()));
...
<body class="g-sidenav-show  bg-gray-100" >
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                    ...
                    <form class="formulario frmNuevo" role="form" id="sign_in">
                        <div class="row">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value="<?php echo $Sucursales->getSucursal(); ?>" id="sucursal" name="sucursal" placeholder="sucursal" required>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value="<?php echo $Sucursales->getDireccion(); ?>" id="direccion" name="direccion" placeholder="direccion" required>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value="<?php echo $Sucursales->getTelefono(); ?>" id="telefono" name="telefono" placeholder="telefono" required>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value="<?php echo $Sucursales->getCodpostal(); ?>" id="codpostal" name="codpostal" placeholder="cod postal" required>
                            </div>
                            </div>
                              ...
                              <div class="form-group">
                                <select class="form-control" name="refzonas" id="refzonas">
                                  <?php foreach ($Zonas->traerTodos() as $row) { ?>
                                    <?php if ($Sucursales->getRefzonas() == $row['id']) { ?>
                                      <option value="<?php echo $row['id']; ?>" selected><?php echo $row['zona']; ?></option>
                                    <?php } else { ?>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value="<?php echo $Sucursales->getLatitud(); ?>" id="latitud" name="latitud" placeholder="latitud" required>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value="<?php echo $Sucursales->getLongitud(); ?>" id="longitud" name="longitud" placeholder="sucursal" required>
                            </div>
                            </div>
                            ...
                            <input type="hidden" name="idmodificar" id="idmodificar" value="<?php echo $id; ?>"/>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn bg-gradient-warning nuevo">Modificar</button>
                        </div>
                        </form>
                    </div>
    ...
    <script>
      ...
      function initMap() {
        <?php
            if (($Sucursales->getLatitud() != '') && ($Sucursales->getLongitud() != '')) {
            ?>
            const center = { lat: <?php echo $Sucursales->getLatitud(); ?>, lng: <?php echo $Sucursales->getLongitud(); ?> };
            <?php } else { ?>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('.btnVolver').click(function() {
                ...
                $(location).attr('href','sucursales.php?id=<?php echo $idcliente; ?>');
