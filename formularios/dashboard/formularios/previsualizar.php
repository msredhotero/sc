...
$refformularios = $_GET['id'];

$Formularios->buscarPorId($refformularios);
...
$Formulariosconector = new Formulariosconector($reftabla,$idreferencia);
$Formulariosconector->setReftabla($reftabla);
$Formulariosconector->setIdreferencia($idreferencia);
//$Formulariosconector->traerPorReferencia();

//
$reftabladestino = 0;
$idreferenciadestino = 0;
$refformulariosconector = 0;
...
foreach ($Formulariosconector->traerPorReferencia() as $rowFF) {
    ...
    $refformulariosconector = $rowFF['id'];
    //
}
...
$entityAux = new Formulariosdetalles($_SESSION['user']->getUsername());
...
//die(var_dump(file_get_contents('../../data/ot/polygon-background10-preview.jpg')));
$entity->save();

*/
//$entity->buscarPorId(1);

$ruta = $Formularios::RUTA;
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row">
          <?php 
            if (count($entity->traerPorReferencia())>0) {
              echo '<button type="button" class="btn bg-gradient-danger btnEliminar">
              ELIMINAR
          </button>';
              require('../../forms/formularios/ver.php'); 
            } else {
              require('../../forms/formularios/formulario.php'); 
            }
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.btnEliminar').click(function() { 
                $.ajax({
                    url: '../../api/formulariosdetalles/eliminar.php',
                    type: 'POST',
                    // Form data
                    //datos del formulario
                    data: { 
                      reftabla: <?php echo $reftabladestino; ?>, 
                      idreferencia: <?php echo $idreferenciadestino; ?>,
                      refformulariosconector: <?php echo $refformulariosconector; ?>
                    },
                    //mientras enviamos el archivo
                    beforeSend: function(){
                    ...
                    success: function(data){
                        ...
                        if (data.error) {
                            ...
                            $(location).attr('href','previsualizar.php?id=<?php echo $idreferencia; ?>');
