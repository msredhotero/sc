...
$refpreguntascuestionario = $_GET['id'];
$Preguntascuestionario->buscarPorId($refpreguntascuestionario);
...
$ruta = $Respuestascuestionario::RUTA;
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row">
          <h4>Pregunta: <?php echo $Preguntascuestionario->getPregunta(); ?></h4>
    ...
    <script>
        $(document).ready(function(){
          $('.btnVolver').click(function() {
              ...
              $(location).attr('href','preguntas.php?id=<?php echo $Preguntascuestionario->getRefformularios(); ?>');
            ...
            var table = $('#example').DataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../../json/jstablasajax.php?tabla=<?php echo $ruta; ?>&refpreguntascuestionario=<?php echo $refpreguntascuestionario; ?>",
                "language": {
