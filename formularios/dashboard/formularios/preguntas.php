...
$ruta = $Preguntascuestionario::RUTA;
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row">
          <h4>Formulario: <?php echo $Formularios->getFormulario(); ?></h4>
        ...
        $(document).ready(function(){
          $('.btnVolver').click(function() {
            ...
            var table = $('#example').DataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../../json/jstablasajax.php?tabla=<?php echo $ruta; ?>&refformularios=<?php echo $refformularios; ?>",
                "language": {
