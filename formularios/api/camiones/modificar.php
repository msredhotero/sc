...
if ($entity != null) {
    $entity->modificarFilter(array('refactivos'=>$refactivos,'refmarcas'=>$refmarcas,'modelo'=>$modelo,'anio'=>$anio,'patente'=>$patente,'chasis'=>$chasis,'nromotor'=>$nromotor,'activo'=>$activo));
