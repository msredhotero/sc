        ...
        <table id="example" class="table align-items-center mb-0 display " style="width:100%">
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tipo Pregunta</th>
              ...
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Obligatorio</th>
