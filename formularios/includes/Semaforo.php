...
class Semaforo {
    ...
    const TABLA = 'tbsemaforo';
    const CAMPOS = 'nivel,color,tiempoestimado';
    const CAMPOSVAR = ':nivel,:color,:tiempoestimado';
    const RUTA = 'semaforo';
    ...
    public function buscarPorId($id) {
        ...
        if($res){
           ...
           $this->cargar($res['nivel'],$res['color'],$res['tiempoestimado']);
           $this->setId($id);
    ...
    public function cargar($nivel, $color, $tiempoestimado) {
    ...
    public function traerAjax($length, $start, $busqueda,$colSort,$colSortDir) {
        ...
        if ($busqueda != '') {
            $where = " where (t.nivel like '%".$busqueda."%' )";
        }
