...
class Tareas {
    ...
    const CAMPOS = 'tarea,refpadre,activo';
    const CAMPOSVAR = ':tarea,:refpadre,:activo';
    const RUTA = 'tareas';
    ...
    public function buscarPorId($id) {
        ...
        if($res){
           ...
           $this->cargar($res['tarea'],$res['activo'],$res['refpadre']);
           $this->setId($id);
    ...
    public function cargar($tarea,$activo,$refpadre) {
        $this->setTarea($tarea);
        $this->setActivo($activo);
        $this->setRefpadre($refpadre);
     }
    ...
    public function traerAjax($length, $start, $busqueda,$colSort,$colSortDir) {
        ...
        tt.tarea as tareapadre
        from ".self::TABLA." t
        left join ".self::TABLA." tt on tt.id = t.refpadre
        ".$where."
    ...
    /**
     * Get the value of refpadre
     */ 
    public function getRefpadre()
    {
        return $this->refpadre;
    }

    /**
     * Set the value of refpadre
     *
     * @return  self
     */ 
    public function setRefpadre($refpadre)
    {
