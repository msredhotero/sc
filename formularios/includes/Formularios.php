...
class Formularios {
    ...
    const TABLA = 'tbformularios';
    const CAMPOS = 'formulario,activo';
    const CAMPOSVAR = ':formulario,:activo';
    const RUTA = 'formularios';
    ...
    public function buscarPorId($id) {
        ...
        if($res){
           ...
           $this->cargar($res['formulario'],$res['activo']);
           $this->setId($id);
    ...
    public function cargar($formulario, $activo) {
    ...
    public function traerAjax($length, $start, $busqueda,$colSort,$colSortDir) {
        ...
        if ($busqueda != '') {
            $where = " where (t.formulario like '%".$busqueda."%' )";
        }
