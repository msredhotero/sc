...
class Materiales {
    ...
    const TABLA = 'tbmateriales';
    const CAMPOS = 'material';
    const CAMPOSVAR = ':material';
    ...
    public function traerTodos() {
        ...
        $sql = "SELECT id,".self::CAMPOS." FROM ".self::TABLA." order by 2 ";
    ...
    public function traerTodosFilter($arCampos) {
        ...
        $sql = "select id,material from ".self::TABLA." where ".$set." ";
    ...
    public function cargar($material) {
    ...
    public function traerAjax($length, $start, $busqueda,$colSort,$colSortDir) {
        ...
        if ($busqueda != '') {
            $where = " (r.material like '%".$busqueda."%' )";
        }
