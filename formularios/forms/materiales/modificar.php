    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel2">Modificar Materiales</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <label for="zona" class="control-label">Material</label>
                        <div class="form-group">
                            <input type="text" class="form-control" id="material" name="material" placeholder="zona" required>
                        </div>
                    </div>
