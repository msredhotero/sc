    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel2">Modificar Solicitud de Visitas Tareas</h5>
            ...
            <div class="col-12">
              ...
              <div class="form-group">
                <textarea rows="3" class="form-control" id="observaciones" name="observaciones" placeholder="observaciones" ></textarea>
                    ...
                    <input type="hidden" name="accion" id="accion" value="modificarSolicitudvisitadetalles"/>
