                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data.error) {
                            ...
                            $('.frmModificar #refactivos').val(data.datos.refactivos);
                            $('.frmModificar #refmarcas').val(data.datos.refmarcas);
                            $('.frmModificar #modelo').val(data.datos.modelo);
                            $('.frmModificar #anio').val(data.datos.anio);
                            $('.frmModificar #patente').val(data.datos.patente);
                            $('.frmModificar #chasis').val(data.datos.chasis);
                            $('.frmModificar #nromotor').val(data.datos.nromotor);
                            $('.frmModificar #tipo').val(data.datos.tipo);
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            if (data.error) {
                                ...
                                $('#lgmNuevo #modelo').val('');
                                $('#lgmNuevo #anio').val('');
                                $('#lgmNuevo #patente').val('');
                                $('#lgmNuevo #chasis').val('');
                                $('#lgmNuevo #nromotor').val('');
                                $('#lgmNuevo #tipo').val('');
