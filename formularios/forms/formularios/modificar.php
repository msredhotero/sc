                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="formulario" name="formulario" placeholder="formulario" required>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="accion" id="accion" value="modificarFormularios"/>
