...
$entity = new Archivospersonal($id);
...
?>
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data.error) {
                            ...
                            $('.frmModificar #refpersonal').val(data.datos.refpersonal);
                            $('.frmModificar #refarchivos').val(data.datos.refarchivos);
            ...
            $("#example").on("click",'.btnDocumentos', function(){
                idTable =  $(this).attr("id");
			    $(location).attr('href','documentos.php?id=' + idTable + '&ref=7&archivo=<?php echo $refarchivos; ?>');
            });
