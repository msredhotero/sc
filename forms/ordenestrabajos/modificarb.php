...
<div class="modal fade modal2" id="lgmModificarReparacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="frmModificarReparacion" role="form" id="sign_in">
                <div class="row">
