                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data.error) {
                            ...
                            $('.frmModificar #tiposervicio').val(data.datos.tiposervicio);

                            for(let i = 0; i < data.activos.length; i++) {
                                //alert(data.activos[i].refactivos);
                                $('.frmModificar #refactivos'+data.activos[i].refactivos).prop('checked', true);
