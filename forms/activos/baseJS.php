                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data.error) {
                            ...
                            $('.frmModificar #activo').val(data.datos.activo);

                            if (data.datos.conmotor == '1') {
                                $('.frmModificar #conmotor').prop('checked',true);
                            } else {
                                $('.frmModificar #conmotor').prop('checked',false);
                            }

                            if (data.datos.cargamtrs3 == '1') {
                                $('.frmModificar #cargamtrs3').prop('checked',true);
                            } else {
                                $('.frmModificar #cargamtrs3').prop('checked',false);
                            }
