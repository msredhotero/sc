...
class Permisoscirculacion {
    ...
    public function traerAjax($length, $start, $busqueda,$colSort,$colSortDir) {
        ...
        if ($busqueda != '') {
            $where = " where (t.realizado like '%".$busqueda."%' )";
        }
        ...
        left join dbdocumentaciones d on d.reftabla = 2 and d.idreferencia = t.id
        ".$where."
