...
class Activos {
    ...
    const TABLA = 'tbactivos';
    const CAMPOS = 'activo,conmotor,cargamtrs3';
    const CAMPOSVAR = ':activo,:conmotor,:cargamtrs3';
    const RUTA = 'activos';
    ...
    public function buscarPorId($id) {
        ...
        if($res){
           ...
           $this->cargar($res['activo'],$res['conmotor'],$res['cargamtrs3']);
           $this->setId($id);
    ...
    public function cargar($activo,$conmotor,$cargamtrs3) {

        $this->setActivo($activo);
        $this->setConmotor($conmotor);
        $this->setCargamtrs3($cargamtrs3);
     }
    ...
    public function traerAjax($length, $start, $busqueda,$colSort,$colSortDir) {
        ...
        if ($busqueda != '') {
            $where = " where (t.activo like '%".$busqueda."%' )";
        }
        ...
        t.id,
        t.activo,
        (case when t.conmotor = '1' then 'Si' else 'No' end) as conmotor,
        (case when t.cargamtrs3 = '1' then 'Si' else 'No' end) as cargamtrs3
        from ".self::TABLA." t
        ".$where."
    ...
    /**
     * Get the value of conmotor
     */ 
    public function getConmotor()
    {
        return $this->conmotor;
    }

    /**
     * Set the value of conmotor
     *
     * @return  self
     */ 
     ...
     * Get the value of conmotor
     */ 
    public function getConmotorStr()
    {
        return ($this->conmotor == '1' ? 'Si' : 'No');
    }

    /**
     * Get the value of cargamtrs3
     */ 
    public function getCargamtrs3()
    {
        return $this->cargamtrs3;
    }

    /**
     * Get the value of conmotor
     */ 
    public function getCargamtrs3Str()
    {
        return ($this->cargamtrs3 == '1' ? 'Si' : 'No');
    }

    /**
     * Set the value of cargamtrs3
     *
     * @return  self
     */ 
    public function setCargamtrs3($cargamtrs3)
    {
        $this->cargamtrs3 = $cargamtrs3;
