...
class Tipodocumentacion {
    ...
    const TABLA = 'tbtipodocumentacion';
    const CAMPOS = 'tipodocumentacion';
    const CAMPOSVAR = ':tipodocumentacion';
    const RUTA = 'tipodocumentacion';
    ...
    public function save() {
        ...
        try {
            ...
            $query->execute([
                'tipodocumentacion'      => $this->tipodocumentacion
            ]);
    ...
    public function buscarPorId($id) {
        ...
        if($res){
           ...
           $this->cargar($res['tipodocumentacion']);
           $this->setId($id);
    ...
    public function cargar($tipodocumentacion) {
