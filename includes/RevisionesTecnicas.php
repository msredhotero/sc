...
class Revisionestecnicas {
    ...
    public function traerAjax($length, $start, $busqueda,$colSort,$colSortDir) {
        ...
        left join dbdocumentaciones d on d.reftabla = 3 and d.idreferencia = t.id
        ".$where."
