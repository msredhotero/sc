...
class Archivosflota {
    ...
    const TABLA = 'dbarchivosflota';
    const CAMPOS = 'refcamiones,refarchivos,realizado,vencimiento';
    const CAMPOSVAR = ':refcamiones,:refarchivos,:realizado,:vencimiento';
    const RUTA = 'archivosflota';
    ...
    public function buscarPorId($id) {
        ...
        if($res){
           ...
           $this->cargar($res['refcamiones'],$res['refarchivos'],$res['realizado'],$res['vencimiento']);
           $this->setId($id);
    ...
    public function cargar($refcamiones,$refarchivos,$realizado,$vencimiento) {
    ...
    public function traerAjax($length, $start, $busqueda,$colSort,$colSortDir) {
        ...
        left join dbdocumentaciones d on d.reftabla = 6 and d.idreferencia = t.id
        ".$where."
