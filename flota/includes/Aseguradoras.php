...
class Aseguradoras {
    ...
    const TABLA = 'tbaseguradoras';
    const CAMPOS = 'aseguradora';
    const CAMPOSVAR = ':aseguradora';
    const ELIMINARACCION = 'eliminarAseguradoras';
    const RUTA = 'aseguradoras';
    ...
    public function cargar($aseguradora) {
    ...
    public function traerAjax($length, $start, $busqueda,$colSort,$colSortDir) {
        ...
        if ($busqueda != '') {
            $where = " where (t.aseguradora like '%".$busqueda."%' )";
        }
