...
class Consumocombustible {
    const TABLA = 'dbconsumocombustible';
    const CAMPOS = 'consumo,refcamiones';
    const CAMPOSVAR = ':consumo,:refcamiones';
    const RUTA = 'dbconsumocombustible';
    ...
    $this->cargar($res["consumo"],$res["refcamiones"]);
    $this->setId($id);
    ...
    public function cargar($consumo,$refcamiones) {
