...
class Maridages {
    ...
    const TABLA = 'tbmaridages';
    const CAMPOS = 'maridage';
    const CAMPOSVAR = ':maridage';
    const ELIMINARACCION = 'eliminarMaridages';
    ...
    public function cargar($maridage) {

        $this->setMaridage($maridage);
     }
    ...
    /**
     * Get the value of maridage
     */ 
    public function getMaridage()
    {
        return $this->maridage;
    }

    /**
     * Set the value of maridage
     *
     * @return  self
     */ 
    public function setMaridage($maridage)
    {
        $this->maridage = $maridage;
