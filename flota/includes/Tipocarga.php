...
class Tipocarga {
    const TABLA = 'tbtipocarga';
    const CAMPOS = 'tipocarga,esalimento';
    const CAMPOSVAR = ':tipocarga,:esalimento';
    const RUTA = 'tbtipocarga';
    ...
    $this->cargar($res["tipocarga"],$res["esalimento"]);
    $this->setId($id);
    ...
    public function cargar($tipocarga,$esalimento) {
    $this->setTipocarga($tipocarga);
    $this->setEsalimento($esalimento);
    ...
    public function getEsalimento()
    {
    return $this->esalimento;
    }
    
    public function setEsalimento($esalimento)
    {
