...
<div class="modal fade" id="lgmNuevoReparacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="formularioReparacion frmNuevoReparacion" role="form" id="sign_in">
          <div class="row">
            ...
            <div class="col-6">
              <div class="form-group">
                ...
                <select class="form-control" id="reftareas" name="reftareas">
                  <?php foreach ($Ordenestrabajos->getTareas()->traerTodosFilter(array('esreparacion'=> '1')) as $row) { ?>
            ...
            <div class="col-6">
              <div class="form-group">
                ...
                <select class="form-control" id="refestados" name="refestados">
                  <?php foreach ($Ordenestrabajos->getEstados()->traerTodos() as $row) { ?>
