  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group">
              ...
              <input type="hidden" name="altura" id="altura" value="1"/>
            </div>
          </div>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row">
          ...
          <div class="col">
            <label for="refactivo_filtro" class="control-label">Activo</label>
            <div class="form-group">
              <select class="form-control" name="refactivo_filtro" id="refactivo_filtro">
        ...
        $(document).ready(function(){
            ...
            var table = $('#example').DataTable({
                ...
                "fnServerData": function ( sSource, aoData, fnCallback ) {
                  ...
                  aoData.push( { "name": "refactivos", "value": $('#refactivo_filtro').val(), } );
