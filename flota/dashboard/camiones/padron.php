...
$Archivosflota = new Archivosflota($id);
    ...
    <script>
        $(document).ready(function(){
            ...
            var table = $('#example').DataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../../json/jstablasajax.php?tabla=<?php echo $ruta; ?>&refcamiones=<?php echo $id; ?>&refarchivos=<?php echo $refarchivos; ?>",
                "language": {
