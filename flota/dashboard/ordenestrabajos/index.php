...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main" data-color="warning">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://negociar.cl" target="_blank">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <button type="button" class="btn bg-gradient-warning" data-bs-toggle="modal" data-bs-target="#lgmNuevoReparacion">
            AGREGAR REPARACIÓN
        </button>
        <?php
        }
    ...
    <?php require('../../forms/'.$ruta.'/insertarb.php'); ?>

    <?php require('../../forms/'.$ruta.'/modificarb.php'); ?>
    ...
    <script>
        $(document).ready(function(){
            var table = $('#example').DataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../../json/jstablasajax.php?tabla=<?php echo $ruta; ?>&tipo=2&sinhistorico='1'",
                "language": {
