...
$Personal->buscarPorId($entity->getRefpersonal());
...
$options['ids'] = '8,9,10';
$options['refgrupos'] = '4';
$options['idobligatorio'] = $entity->getRefpersonal();
?>
        ...
        $(document).ready(function(){
          ...
          function traerImagen(contenedorpdf, contenedor, options) {
            ...
            $('.btnVolver').click(function() {  
              $(location).attr('href','<?php echo $tipo; ?>.php?id=<?php echo $entity->getRefpersonal(); ?>');
            });
